...
//    return (<>
//      <div className="bg-blue-100 rounded-xl shadow-md p-6 w-70 h-100 text-center">
//    <img src={user.image} alt="image" className="w-24 h-24 rounded-full border-4 border-white mx-auto mb-4 object-cover" />
//    <h5 className="text-lg font-semibold text-gray-800 mb-4">{user.name}</h5>
  
 
  
//      <progress value="48" max="100" className="w-full h-3 mt-3 rounded-lg overflow-hidden bg-black"></progress>
   
//      <RoutineCard routines={user.routines}/>
